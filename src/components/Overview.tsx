...
export default function Overview({ onNextTab }: OverviewProps) {
  return (
    <div className="space-y-10 max-w-4xl" id="overview-component">
      {/* Hero Welcome banner */}
      <div className="bg-gradient-to-br from-indigo-50/70 to-white border border-indigo-100 dark:border-indigo-800/50 p-6 sm:p-8 rounded-3xl space-y-4">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 rounded-full border border-indigo-100 dark:border-indigo-800/50 text-[10px] font-bold">
          <Sparkles className="w-3.5 h-3.5 animate-pulse" />
          Kavio Edu Specification Live Preview
        </div>
        
        <h1 className="text-3xl font-display font-bold text-gray-900 dark:text-white tracking-tight leading-tight">
          Sistem Desain & Panduan UI/UX <br />
          <span className="text-indigo-600 dark:text-indigo-400">KAVIO EDU</span>
        </h1>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-slate-400">Lima pilar utama yang menjadi pondasi seluruh komponen Kavio Edu.</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div className="border border-gray-100 dark:border-slate-700/50 bg-white dark:bg-slate-800 p-5 rounded-2xl shadow-3xs space-y-2">
            <span className="font-semibold text-xs text-gray-900 dark:text-white block">⚡ Fast & Responsive</span>
          ...
          <div className="border border-gray-100 dark:border-slate-700/50 bg-white dark:bg-slate-800 p-5 rounded-2xl shadow-3xs space-y-2">
            <span className="font-semibold text-xs text-gray-900 dark:text-white block">🎨 Minimalist Vercel Language</span>
            <p className="text-[11px] text-gray-400 leading-relaxed">
          ...
          <div className="border border-gray-100 dark:border-slate-700/50 bg-white dark:bg-slate-800 p-5 rounded-2xl shadow-3xs space-y-2">
            <span className="font-semibold text-xs text-gray-900 dark:text-white block">📱 Mobile-Safety & Touch-First</span>
            <p className="text-[11px] text-gray-400 leading-relaxed">
      ...
      <div className="border border-gray-100 dark:border-slate-700/50 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-3xs space-y-4">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-gray-600 dark:text-slate-300 font-medium">
      ...
      {/* Developer note */}
      <div className="p-4 bg-amber-50 dark:bg-amber-900/30 border border-amber-200/50 rounded-2xl flex items-start gap-3 text-xs text-amber-800">
