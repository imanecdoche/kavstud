...
export function SkeletonCard() {
  return (
    <div className="bg-white border border-gray-100 p-6 rounded-3xl space-y-4 animate-pulse">
...
export function SkeletonList({ items = 4 }: { items?: number }) {
  return (
    <div className="bg-white border border-gray-100 rounded-3xl p-6 space-y-4 animate-pulse">
      <div className="h-4 bg-gray-200 rounded-md w-1/4 mb-6" />
  ...
  return (
    <div className="space-y-8 animate-pulse">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="h-28 bg-white border border-gray-100 rounded-2xl p-5 space-y-3">
          <div className="h-2.5 bg-gray-200 rounded-md w-1/2" />
          <div className="h-7 bg-gray-200 rounded-md w-1/4" />
        </div>
        <div className="h-28 bg-white border border-gray-100 rounded-2xl p-5 space-y-3">
          <div className="h-2.5 bg-gray-200 rounded-md w-1/2" />
          <div className="h-7 bg-gray-200 rounded-md w-1/4" />
        </div>
        <div className="h-28 bg-white border border-gray-100 rounded-2xl p-5 space-y-3 sm:col-span-2 lg:col-span-1">
          <div className="h-2.5 bg-gray-200 rounded-md w-1/2" />
          <div className="h-7 bg-gray-200 rounded-md w-1/4" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        <div className="xl:col-span-2 space-y-8">
          <div className="h-64 bg-white border border-gray-100 rounded-3xl p-6" />
          <div className="h-64 bg-white border border-gray-100 rounded-3xl p-6" />
        </div>
        <div className="h-96 bg-white border border-gray-100 rounded-3xl p-6" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="space-y-8 animate-pulse max-w-5xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="h-48 bg-white border border-gray-100 rounded-3xl p-6" />
