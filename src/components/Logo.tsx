  ...
  return (
    <div className={`inline-flex items-center gap-2 select-none ${className}`}>
      ...
      <div className="flex items-center gap-1 leading-none">
        <span className="font-display font-black text-lg sm:text-xl tracking-tight uppercase text-gray-900 dark:text-white">
          KAVIO
        </span>
        <span className="font-sans font-bold text-xs uppercase text-[#1CB0F6] bg-[#1CB0F6]/10 dark:bg-[#1CB0F6]/20 px-1.5 py-0.5 rounded-md border border-[#1CB0F6]/30">
          EDU
        </span>
      </div>
    </div>
