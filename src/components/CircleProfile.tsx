...
export default function CircleProfile({ circleId, onNavigate, onSetLoading }: CircleProfileProps) {
  ...
  const handleRemoveMember = async (studentId: string, studentName: string) => {
    if (!window.confirm(`Keluarkan ${studentName} dari Circle ${circle?.name}?`)) {
      return;
    }
    ...
    try {
      ...
      console.error(err);
      alert('Gagal mengeluarkan siswa dari Circle.');
    } finally {
      onSetLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-8 lg:p-12 space-y-8 max-w-6xl mx-auto" id="circle-profile-page">
      {/* Back button and title */}
      <div className="flex items-center gap-4">
        <button
          onClick={() => onNavigate('/teacher')}
          className="p-2.5 bg-white border border-gray-200 hover:border-gray-300 rounded-xl cursor-pointer transition-all active:scale-95"
        ...
        <div>
          <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-wider">Profil Detil Kelompok Belajar</span>
          <h1 className="text-xl sm:text-2xl font-display font-bold text-gray-900 tracking-tight mt-0.5 flex items-center gap-2">
      ...
      {loading ? (
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Metadata Card */}
            <div className="lg:col-span-1 bg-white border border-gray-100 p-6 rounded-3xl shadow-3xs flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center">
                  <CircleDot className="w-6 h-6" />
                </div>
                <div>
                  <h2 className="text-sm font-bold text-gray-900">{circle.name}</h2>
                  <p className="text-[10px] text-gray-400 font-semibold uppercase mt-0.5">ID: {circle.id}</p>
                </div>

                {circle.description && (
                  <p className="text-xs text-gray-500 leading-relaxed bg-gray-50/50 p-3 rounded-2xl border border-gray-100/50">
                    {circle.description}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-3.5 border-t border-gray-50 pt-4 text-xs text-gray-600 font-medium">
                <div className="flex items-center gap-2.5">
                  ...
                  <span>Guru: <strong className="text-gray-800">{teacher?.fullName || 'Memuat...'}</strong></span>
                </div>
                <div className="flex items-center gap-2.5">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span>Kapasitas: <strong className="text-gray-800">{members.length} / {circle.capacity} Siswa</strong></span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="bg-white border border-gray-100 p-6 rounded-3xl shadow-3xs flex flex-col justify-between">
                ...
                <div className="mt-4">
                  ...
                  <span className="text-2xl font-bold font-display text-gray-900 mt-1 block">{totalMembers} / {circle.capacity}</span>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-100 p-6 rounded-3xl shadow-3xs flex flex-col justify-between">
                ...
                <div className="mt-4">
                  ...
                  <span className="text-2xl font-bold font-display text-gray-900 mt-1 block">{totalAssignments}</span>
                </div>
              </div>
              ...
              <div className="sm:col-span-3 bg-white border border-gray-100 p-5 rounded-3xl shadow-3xs space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2.5 text-center">
                  ...
                  <div className="p-3 bg-amber-50/50 border border-amber-100/20 rounded-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
            ...
            <div className="lg:col-span-2 bg-white border border-gray-100 p-6 rounded-3xl shadow-3xs space-y-5">
              ...
              {members.length === 0 ? (
                <div className="py-12 text-center text-gray-400 bg-gray-50/50 rounded-2xl border border-dashed border-gray-100">
                ...
                <div className="space-y-3.5">
                  {members.map(memb => (
                    <div 
                      key={memb.uid}
                      className="p-3.5 bg-gray-50/50 hover:bg-gray-50 border border-gray-100/50 rounded-2xl flex items-center justify-between gap-3 transition-colors"
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-1.5">
                            <h4 className="text-xs font-bold text-gray-900 truncate leading-tight">{memb.fullName}</h4>
                      ...
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          className="p-1.5 text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg shrink-0 transition-colors cursor-pointer"
            ...
            <div className="lg:col-span-3 bg-white border border-gray-100 p-6 rounded-3xl shadow-3xs space-y-5">
              <div className="flex items-center justify-between border-b border-gray-50 pb-3">
                <h3 className="text-sm font-bold text-gray-900 flex items-center gap-1.5">
                  ...
                  {assignments.map(assign => {
                    ...
                    return (
                      <div
                        ...
                        className="bg-gray-50/30 hover:bg-gray-50 border border-gray-100/70 p-4.5 rounded-2xl cursor-pointer transition-all hover:shadow-4xs flex flex-col justify-between space-y-3.5 group"
                      >
                        <div className="space-y-1.5">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-[8px] font-mono font-bold text-indigo-600 flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                              Detail Progress
                        ...
                        <div className="border-t border-gray-100/50 pt-2.5 flex items-center justify-between text-[10px] text-gray-500">
                          <span className="font-mono">
                            Dibuat: {assign.createdAt ? new Date(assign.createdAt.seconds * 1000).toLocaleDateString('id-ID', {day: 'numeric', month: 'short'}) : '-'}
                          </span>
                          
                          <span className="font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full font-mono">
